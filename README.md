...
2. In your terminal, type the following command: cd listEditor/main
3. Compile the program using: gcc -o list_editor main.c buffer_functions.c buffer_editing.c -lncurses -lpthread
4. Run the program using: ./list_editor
5. To show the multi-user functionality, open another terminal and run the application (redo steps 2 through 4)
...
4. buffer_editing.c: This file contains the functions used to edit the buffer. The functions are:
